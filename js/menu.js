...
function ($sce, $scope, $rootScope, $log, $window, $timeout, $location, $interval,
    ...
    avatarPool.push("http://rshen1993.github.io/GamingPlatform/img/a5.png");
    avatarPool.push("http://rshen1993.github.io/GamingPlatform/img/a6.png");
    ...
    rescaleDivs = function () {
                                ...
                                if (div_menubottom !== undefined) {
                                    ...
                                    icon_pass.style.fontSize = (height_menubottom - 20) + 'px';
                                    icon_match.style.fontSize = (height_menubottom - 20) + 'px';
                                    icon_AI.style.fontSize = (height_menubottom - 20) + 'px';
                                }
    }
    rescaleDivs();
