...
this.rescaleDivs = function () {
                                ...
                                if (div_players!==undefined && div_av0!==undefined) {
                                    ...
                                    if (div_players.clientWidth < div_players.clientHeight * 10) {
                                        div_av0.style.height = (div_players.clientWidth / 10)-4 + 'px';
                                        div_av0.style.width = (div_players.clientWidth / 10)-4 + 'px';
                                        div_av1.style.height = (div_players.clientWidth / 10)-4 + 'px';
                                        div_av1.style.width = (div_players.clientWidth / 10)-4 + 'px';
                                    }
                                }
                            }
